...
public class WakingAzkarAdapter extends RecyclerView.Adapter<WakingAzkarAdapter.ViewHolder> {
    public Context context;
    private ArrayList<String> lst_zekir;
    private ArrayList<Integer> lst_counts;

    public WakingAzkarAdapter(Context context, ArrayList<String> lst_zekir, ArrayList<Integer> lst_counts) {
    ...
    @NonNull
    @Override
    public @NotNull WakingAzkarAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_zekr,parent,false);
        return new ViewHolder(view);    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull WakingAzkarAdapter.ViewHolder holder, int position) {
